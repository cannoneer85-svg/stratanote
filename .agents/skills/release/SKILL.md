...
7.  **Create release commit, tag, and push**:
    ...
    - Run the following commands:
      ...
      powershell -Command "Get-ChildItem -Path docs/api-reference -Filter *.md -Recurse | ForEach-Object { (Get-Content $_.FullName) -replace 'obsidian-collab', 'stratanote' | Set-Content $_.FullName }"
