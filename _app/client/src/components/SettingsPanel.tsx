...
import { X, Upload, UserPlus, Trash2, AlertTriangle, Check, Users, ShieldAlert, FolderOpen, Edit2, Image, Search, Info, RefreshCw, Globe, Play, ExternalLink, Sparkles, CheckCheck, LayoutTemplate } from 'lucide-react';
...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'general' | 'import' | 'users' | 'media' | 'about' | 'sync' | 'trash' | 'templates'>('general');
