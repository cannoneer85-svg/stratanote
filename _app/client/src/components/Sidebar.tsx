...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div className="flex flex-col h-full w-full bg-background-panel border-r border-white/5 overflow-visible text-left select-none">
        ...
        <div className="flex items-center space-x-1.5">
          ...
          {onOpenSettings && (
            <button
              ...
              className="p-1.5 hover:bg-white/5 hover:text-primary text-text-disabled rounded-lg transition-colors cursor-pointer focus:outline-none"
          ...
          <button
            onClick={onLogout}
            className="p-1.5 hover:bg-white/5 hover:text-red-400 text-text-disabled rounded-lg transition-colors cursor-pointer focus:outline-none"
      ...
      {/* Tabs Switcher */}
      <div className="px-3 pb-2 flex space-x-1 border-b border-white/5 bg-black/5 pt-1">
        <button
