...
if (arg2 === '--publish') {
  ...
  // Создаем копию CHANGELOG.md для Mintlify в папке docs
  const mintlifyChangelogPath = path.join(rootDir, 'docs', 'changelog.md');
  const frontmatter = `---\ntitle: "Changelog"\nsidebarTitle: "Changelog"\ndescription: "История изменений и обновлений проекта StrataNote"\n---\n\n`;
  
  // Убираем главный заголовок # Changelog, чтобы избежать его дублирования на сайте (поддерживаем LF и CRLF)
