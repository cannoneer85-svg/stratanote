[**API Reference**](/api-reference/index) / [**SearchModal**](/api-reference/components/SearchModal/index)

***

> `const` **SearchModal**: `React.FC`\<`SearchModalProps`\>

Defined in: [components/SearchModal.tsx:41](https://github.com/cannoneer85-svg/stratanote/blob/master/_app/client/src/components/SearchModal.tsx#L41)
