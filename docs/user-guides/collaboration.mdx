...
description: "Use document locking, moderated change suggestions, and version history in StrataNote to co-author notes safely and roll back edits when needed."
---
