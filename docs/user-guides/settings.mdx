...
* **Format Groups:** Images, videos, audio files (.mp3), archives (.zip), and PDFs are grouped into categories, with unrecognized files placed in **"Other"**.
...
* **Visual Update Notifications:**
  ...
  * **About Screen:** Displays a banner letting you know a new release is available with direct links to the release notes.
