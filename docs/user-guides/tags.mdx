...
StrataNote treats tags as a first-class way to organize notes across folders. In addition to writing tags inside your notes, you can browse them from a dedicated sidebar tab, preview them on document cards, and see tag-based relationships on the interactive graph.
